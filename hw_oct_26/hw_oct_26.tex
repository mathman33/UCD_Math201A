...
% Let $G \in \mathcal{T}_2$.  Then $G$ is open with respect to $d_2$.  Then $\forall x \in G$, $\exists \varepsilon$ such that $B_{2,\varepsilon}(x) \in G$.  Note that $d_2(x,y) < \epsilon$ for each $y \in B_{2,\varepsilon}(x)$.  Now consider $B_{1,\varepsilon/c}(x)$.  If $y \in B_{1,\varepsilon/c}(x)$, then $d_1(x, y) < \frac{\varepsilon}{c}$, which implies $d_2(x, y) < \varepsilon$, which then implies $y \in B_{2, \varepsilon}(x)$.  Thus $B_{1,\varepsilon/c}(x) \subset B_{2,\varepsilon}(x)$, and so $B_{1,\varepsilon/c}(x) \subset G$.  Thus there is an open ball with respect to the metric $d_1$ around any point $x$ in $G$.  Thus $G$ is open with respect to the metric $d_1$, and thus $G \in \mathcal{T}_1$.

  % Thus $cd_1(x, y) < \epsilon$, or $d_1(x, y) < \frac{\epsilon}{c}$.
